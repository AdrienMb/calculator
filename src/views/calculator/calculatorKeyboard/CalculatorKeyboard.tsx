...
function CalculatorKeyboard({ handleClick, isCurrentCalcEmpty} : Props) {
  ...
  const firstRow : ArithmeticIO[] = [
    {label: '(', type: 'operand', value: '(', inputColor: 'grey'},
    {label: ')', type: 'operand', value: ')', inputColor: 'grey'},
    {label: '%', type: 'operand', value: '%', inputColor: 'grey'},
  ...
  const thirdRow : ArithmeticIO[] = [
    ...
    {label: 'x', type: 'operand', value: '*', inputColor: 'grey'}];
  ...
  const fithRow : ArithmeticIO[] = [
    {label: '0', type: 'operand', value: '0', inputColor: 'default'},
    {label: ',', type: 'operand', value: '.', inputColor: 'default'},
    {label: '=', type: 'action', value: '=', inputColor: 'blue'},
    {label: '+', type: 'operand', value: '+', inputColor: 'grey'}];
